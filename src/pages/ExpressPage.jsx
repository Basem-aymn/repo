        ...
        <section className="py-16 px-6 mt-16">
          ...
          >
            {expressOptions.map((option, index) => (
              <motion.div key={index} className="relative bg-gradient-to-br from-blue-50 via-white to-indigo-100 p-6 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-500 w-full mt-4 md:mt-0 border border-blue-200 overflow-hidden group" variants={cardVariants}>
                <div className="absolute top-4 right-4 bg-gradient-to-r from-blue-500 to-indigo-500 text-white p-2 rounded-full shadow-lg">
                ...
                <div className="text-center">
                  ...
                  <h3 className="text-xl font-bold text-gray-800 mb-2 group-hover:text-blue-600 transition-colors duration-300">{option.title}</h3>
                  <p className="text-gray-600 mb-3 leading-relaxed text-sm">
                    {option.description}
                  </p>
                  <p className="text-2xl font-bold text-blue-600 mb-4">{option.price}</p>
                  <button className="inline-block bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-2 rounded-full font-semibold hover:from-blue-700 hover:to-indigo-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 hover:scale-105">
                    {t("orderNow")}
                  </button>
                </div>
